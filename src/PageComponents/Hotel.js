...
import { faMinus, faPlus, faTimes, faHeart, faStar, faList, faTh, faMap } from '@fortawesome/free-solid-svg-icons';
...
// State for dropdown visibility start
  ...
  const [isHotelStarDropdownOpen, setHotelStarDropdownOpen] = useState(false);
  const [isFacilitiesDropdownOpen, setFacilitiesDropdownOpen] = useState(false);
  const [isHotelThemeDropdownOpen, setHotelThemeDropdownOpen] = useState(false);

  const togglePriceDropdown = () => {
  setReviewScoreDropdownOpen(false);
  setHotelStarDropdownOpen(false);
  setFacilitiesDropdownOpen(false);
  setHotelThemeDropdownOpen(false);
...
const toggleHotelStarDropdown = () => {
  setPriceDropdownOpen(false);
  setReviewScoreDropdownOpen(false);
  setFacilitiesDropdownOpen(false);
  setHotelThemeDropdownOpen(false);
  setHotelStarDropdownOpen(!isHotelStarDropdownOpen);
};
...
const toggleHotelThemeDropdown = () => {
  setPriceDropdownOpen(false);
  setReviewScoreDropdownOpen(false);
  setHotelStarDropdownOpen(false);
  setFacilitiesDropdownOpen(false);
  setHotelThemeDropdownOpen(!isHotelThemeDropdownOpen);
};
...
/*Map End*/
  ...
  return (
    <>
      <Header />
      <div id="st-content-wrapper" className="st-style-elementor search-result-page layout5" data-layout="5" data-format="halfmap">
				...
				<ul>
				    <li className="filter-price">
				      <div className="form-extra-field">
				        ...
				        <div className={`dropdown-menu range-slider${isPriceDropdownOpen ? ' show' : ''}`} style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate(390px, 78px)' }} >
  					...
  					<li className="filter-review-score">
  						<div className="form-extra-field">
  							...
  							<div className={`dropdown-menu st-icheck${isReviewScoreDropdownOpen ? ' show' : ''}`} aria-labelledby="dropdownMenuReviewScore" style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate(534px, 78px)' }} data-popper-placement="bottom-start">
  					...
  					<li className="filter-review-score">
  						<div className="form-extra-field">
  							<button className={`btn btn-link dropdown dropdown-toggle${isHotelStarDropdownOpen ? ' show' : ''}`} type="button" id="dropdownMenuHotelStar" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="true" onClick={toggleHotelStarDropdown}>
  								Hotel Star <span className="count"></span> 
  								<span className="stt-icon stt-icon-arrow-down"></span>
  							</button>
  							<div className={`dropdown-menu st-icheck${isHotelStarDropdownOpen ? ' show' : ''}`} style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate(700px, 78px)' }} data-popper-placement="bottom-start">
  								<div className="dropdown-title">Hotel star</div>
  								<ul>
  									<li className="st-icheck-item">
  										<label>
  											<i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> 

  											<input type="checkbox" name="review_score" data-type="hotel_rate" value="5" className="filter-item" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  									</li>
  									<li className="st-icheck-item">
  										<label>
  											...
  											<input type="checkbox" name="review_score" data-type="hotel_rate" value="4" className="filter-item" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  									</li>
  									<li className="st-icheck-item">
  										<label>
  											...
  											<input type="checkbox" name="review_score" data-type="hotel_rate" value="3" className="filter-item" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  									</li>
  									<li className="st-icheck-item">
  										<label>
  											...
  											<input type="checkbox" name="review_score" data-type="hotel_rate" value="2" className="filter-item" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  									</li>
  									<li className="st-icheck-item">
  										<label>
  											...
  											<input type="checkbox" name="review_score" data-type="hotel_rate" value="1" className="filter-item" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  									</li> 
  								</ul>
  					...
  					<li className="filter-review-score taxonomy">
  						<div className="form-extra-field">
  							<button className={`btn btn-link dropdown dropdown-toggle${isFacilitiesDropdownOpen ? ' show' : ''}`} type="button" id="dropdownMenuFacilities" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false" onClick={toggleFacilitiesDropdown}>
  								Facilities <span className="count"></span> 
  								<span className="stt-icon stt-icon-arrow-down"></span>
  							</button>
  							<div className={`dropdown-menu st-icheck${isFacilitiesDropdownOpen ? ' show' : ''}`} aria-labelledby="dropdownMenuFacilities" style={{
  								position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate(844px, 78px)',
  							}}>
  								<div className="st-scrollbar dropdown-menu-inner">
  									...
  									<ul> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Best value 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="16" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Boutique 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="17" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Budget 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="18" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  										<label>Business 
  											<input data-tax="taxonomy" data-type="hotel-theme" value="19" type="checkbox" name="taxonomy" className="filter-tax" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Charming 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="20" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>classNameic 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="21" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Green 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="22" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Luxury 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="23" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  										<label>Mid-range 
  											<input data-tax="taxonomy" data-type="hotel-theme" value="24" type="checkbox" name="taxonomy" className="filter-tax" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  										<label>Party 
  											<input data-tax="taxonomy" data-type="hotel-theme" value="25" type="checkbox" name="taxonomy" className="filter-tax" />
  											<span className="checkmark fcheckbox"></span>
  										</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Quaint 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="26" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Quite 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="27" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Romantic 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="28" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Standard 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="29" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Trendy 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="30" type="checkbox" name="taxonomy" className="filter-tax" />
  												<span className="checkmark fcheckbox"></span>
  											</label>
  										</li>
  									</ul> 
  					...
  					<li className="filter-review-score taxonomy">
  						<div className="form-extra-field">
  							<button className={`btn btn-link dropdown dropdown-toggle${isHotelThemeDropdownOpen ? ' show' : ''}`} type="button" id="dropdownMenuFacilities" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="true" onClick={toggleHotelThemeDropdown}>
  								Hotel Theme <span className="count"></span> 
  								<span className="stt-icon stt-icon-arrow-down"></span>
  							</button>
  							<div className={`dropdown-menu st-icheck${isHotelThemeDropdownOpen ? ' show' : ''}`} style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate(981px, 78px)' }} data-popper-placement="bottom-start" data-popper-reference-hidden="">
  						      	<div className="st-scrollbar dropdown-menu-inner">
  									<div className="dropdown-title">Hotel Theme</div>
  									<ul> 
  										<li className=" st-icheck-item" style={{}}>
  											<label>Best value 
  												<input data-tax="taxonomy" data-type="hotel-theme" value="16" type="checkbox" name="taxonomy" className="filter-tax" />
	    	...
	    	{/* st-hotel-result sticky-halfmap start */}
	    		...
	    		<div className="st-results st-hotel-result" id="sticky-halfmap">
	    			<div className="service-list-wrapper page-half-map map-right">
	    						...
	    						<ul className="toolbar-action d-none d-md-flex align-items-center justify-content-right">
									<li>
										<div className="form-extra-field dropdown ">
											...
											{isSortDropdownMenuOpen && (<div className="dropdown-menu dropdown-menu-end sort-menu" aria-labelledby="dropdownMenuSort" style={{
										            position: 'absolute',
                      ...
                      <span className="stt-icon stt-icon-category">
                        <FontAwesomeIcon icon={faTh} className="stt-icon stt-icon-grid" />
  								...
  								<h2 className="search-string modern-result-string" id="modern-result-string">
  									14 hotels found in <span>California</span>
	    					...
	    					<div id="modern-search-result" className="modern-search-result st-scrollbar" data-format="halfmap" data-layout="2">
    							...
    							<div className="show-map-mobile">
    								<Link to="#">
    									<span className="stt-icon stt-icon-map">
    										<FontAwesomeIcon icon={faMap} className="stt-icon stt-icon-map" />
    									</span> Map 
    								</Link>
    							</div>
	    				</div>
